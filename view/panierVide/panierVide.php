...
<body class="d-flex flex-column">
    <nav class="navbar navbar-light navbar-expand-md" style="background: #ebd9d5;">
        <div class="container-fluid"><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button><img src="assets/img/logo.png" style="width: 50px;">
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"></li>
                </ul><button class="btn btn-primary d-xxl-flex" type="button" style="background: rgb(211,110,112);margin-left: auto;font-family: 'Abhaya Libre', serif;font-weight: bold;font-size: 18px;letter-spacing: 1px;">Connexion</button>
            </div>
        </div>
    </nav>
