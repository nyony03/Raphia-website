    ...
    <div class="row d-md-flex d-lg-flex flex-shrink-1" style="padding-top: 110px;">
        ...
        <div class="col-md-6">
            <div style="padding-right: 100px; background: rgba(222,222,222,0.58);border-radius: 25px;padding: 8px;margin-top: 15px;">
                <p style="background: rgba(255,255,255,0);border-style: none;padding: 7px 2px;margin-left: 25px;color: rgb(186,156,156);">Si vous êtes un administrateur !</p>
                <p style="background: rgba(255,255,255,0);border-style: none;padding: 7px 2px;margin-left: 25px;color: rgb(186,156,156);">Veuillez vous authentifier pour pouvoir accéder à la page d'administration du site !</p>
            </div>
        </div>
    </div>
</div>
