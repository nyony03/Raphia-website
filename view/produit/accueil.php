...
<head>
    ...
    <link rel="stylesheet" href="../raphia/view/assets/css/Articles-Cards.css">
    <link rel="stylesheet" href="../raphia/view/assets/css/Navbar-Right-Links.css">
    <link rel="stylesheet" href="../raphia/view/assets/css/styles.css">
</head>

<body>
    <nav class="navbar navbar-light navbar-expand-md" style="background: #ebd9d5;">
        <div class="container-fluid">
            <picture><img src="../raphia/view/assets/img/logo.png" width="50" height="50"></picture><a class="navbar-brand" href="#" style="color: #a75b5b;"><strong><em>Raphia</em></strong></a>
    ...
    <div id="promo" style="background: url('../raphia/view/assets/img/photo-accueil.png') left / cover no-repeat;">
