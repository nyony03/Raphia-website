            ...
            <div class="container-fluid"><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-2"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navcol-2">
                    <ul class="navbar-nav mx-auto">
                        <li class="nav-item"><a class="nav-link active" href="#" style="color: #a75b5b;font-weight: bold;font-size: 20px;">Décoration</a></li>
                        <li class="nav-item"><a class="nav-link" href="#" style="color: #a75b5b;font-weight: bold;font-size: 20px;">Plage</a></li>
                        <li class="nav-item"><a class="nav-link" href="#" style="color: #a75b5b;font-weight: bold;font-size: 20px;">Mode</a></li>
                    </ul>
                </div>
            </div>
        </nav>
...
<div id="article">
    <div class="container py-4 py-xl-5">
        <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
            <div class="col">
                <div class="card"><img class="card-img-top w-100 d-block fit-cover" style="height: 200px;" src="../assets/img/drapPlage.png">
                    <div class="card-body p-4">
                        <h4 class="card-title">Title</h4>
                        <p class="card-text">Description</p>
                        <p class="card-text">Prix</p><button class="btn btn-primary" type="button" style="background: #d36e70;color: rgb(255,255,255);border-width: 0px;opacity: 1;">AJOUT AU PANIER</button>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card"><img class="card-img-top w-100 d-block fit-cover" style="height: 200px;" src="../assets/img/chapeau.png">
                    <div class="card-body p-4">
                        <h4 class="card-title">Title</h4>
                        <p class="card-text">Description</p>
                        <p class="card-text">Prix</p><button class="btn btn-primary" type="button" style="background: #d36e70;color: rgb(255,255,255);border-width: 0px;opacity: 1;">AJOUT AU PANIER</button>
